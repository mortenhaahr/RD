...
The implementation of the \cppinline{addNodeQualNameToCollection} function can be seen on \cref{code:085tool:060enum:tool1_node_processing}.
...
This is because the \cppinline{hasAnyName} matcher creates a copy of the names in the collection at instantiation time.
